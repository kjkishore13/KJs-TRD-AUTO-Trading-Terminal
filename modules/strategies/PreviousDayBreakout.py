...
Trades breakouts above yesterday's high.
"""
...
class PreviousDayBreakout:
    ...
    def __init__(self):
        ...
        self.stop_loss_multiplier = 0.005  # 0.5% below entry
        self.target_multiplier = 0.02       # 2% above entry
        self.position = None
    ...
    def on_candle(self, candle, context):
        ...
        # Calculate yesterday's high and low
        ...
        # Entry condition: Price breaks above yesterday's high
        ...
        if self.position == 'long':
            ...
            # Trailing stop - move stop loss up as price increases
