...
"""
VWAP Alert - Alerts when price crosses VWAP.
"""
...
class VWAPAlert:
    ...
    def on_candle(self, candle, context):
        ...
        Returns: dict with alert data if VWAP crossed
        """
        candles = context.get('candles', [])
        
        if len(candles) < 20:  # Need enough data for VWAP
            return None
