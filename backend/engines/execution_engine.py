...
"""
Execution Engine - Decides what to do with signals.
...
class ExecutionEngine:
    ...
    def _calculate_quantity(self, price):
        ...
        quantity = int(risk_amount / price / 10) * 10  # Round to nearest 10
        
        return max(10, min(quantity, 1000))  # Limit between 10 and 1000
